      ...
      <nav className="section-padding mx-auto flex max-w-6xl items-center justify-between py-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full border border-zinc-300 text-zinc-700 transition-colors hover:border-accent-500 hover:text-accent-600 dark:border-zinc-700 dark:text-zinc-300 dark:hover:border-accent-400 dark:hover:text-accent-400 sm:hidden"
          >
            ...
            <div className="section-padding flex flex-col gap-1 py-4">
              {NAV_LINKS.map((link) => (
                <a
                  ...
                  className="rounded-lg px-3 py-3 text-base font-medium text-zinc-700 transition-colors hover:bg-zinc-100 hover:text-accent-600 dark:text-zinc-300 dark:hover:bg-zinc-900 dark:hover:text-accent-400"
                >
                  {link.label}
                </a>
              ))}
